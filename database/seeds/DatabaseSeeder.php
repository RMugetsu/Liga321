...
class DatabaseSeeder extends Seeder
{
    ...
    {          
        ...
        $jugadores =  [
            ...
            ['','Gonzalez',4,14,28,0,16],
            ['','Olivera',17,14,21,0,17],
            ['','Bergara',5,14,33,0,18],
            //real sociedad
            ['','Soria',13,15,26,0,1], //portero1
            ['','Yañez',25,15,25,0,2], //portero2
            ['','Dakoman',2,15,27,0,3],
            ['','Mata',7,15,30,0,4],
            ['','Shibasaki',15,9,26,0,5],
            ['','Molina',19,15,37,0,6],
            ['','Rodriguez',9,15,32,0,7],
            ['','Portillo',8,15,28,0,8],
            ['','Flamini',16,15,35,0,9],
            ['','Antunes',3,15,32,0,15],
            ['','Cabrera',6,15,27,0,11],
            ['','Maksimovic',20,15,24,0,12],
            ['','Suarez',22,15,31,0,13],
            ['','Arambarri',18,15,23,0,14],
            ['','Saiz',11,15,28,0,15],
            ['','Gonzalez',4,15,28,0,16],
            ['','Olivera',17,15,21,0,17],
            ['','Bergara',5,15,33,0,18],
            //levante
